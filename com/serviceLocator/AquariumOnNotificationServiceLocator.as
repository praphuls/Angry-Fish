package com.serviceLocator  {
	...
	public class AquariumOnNotificationServiceLocator extends MovieClip 
	{
		...
		public function AquariumOnNotificationServiceLocator(obj:ICommand, service:String) 
		{
			callBackObj = obj;
			services = service;
			connectToService();
		...
		public function connectToService():void
		{
			...
			ureq = new URLRequest();
			ureq.url = services + model.aquariumIdPrimary;
