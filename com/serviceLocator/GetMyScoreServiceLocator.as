package com.serviceLocator
{
	 ...
	 * @author ...
	 */
	public class GetMyScoreServiceLocator extends MovieClip 
	{
		...
		public function GetMyScoreServiceLocator(obj:ICommand, service:String) {
			callBackObj = obj;
			services = service;
			connectToService();
		}
		...
		public function connectToService():void
		{
			...
			ureq = new URLRequest();
			ureq.url = services + ASSOCIATE_ID + "=" + model.assocaiteID; trace(ureq.url, "SCORE URL..");
