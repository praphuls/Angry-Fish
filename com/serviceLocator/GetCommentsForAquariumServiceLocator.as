package com.serviceLocator  {
	...
	public class GetCommentsForAquariumServiceLocator extends MovieClip 
	{
		...
		public function GetCommentsForAquariumServiceLocator(obj:ICommand, service:String) {
			callBackObj = obj;
			services = service;
			connectToService();
		}
		...
		public function connectToService():void
		{
			...
			ureq = new URLRequest();
			ureq.url = services + PROBLEM_ID + "=" + model.problemIDHappyFish;
