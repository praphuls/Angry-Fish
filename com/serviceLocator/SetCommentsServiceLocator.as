package com.serviceLocator  {
	...
	public class SetCommentsServiceLocator extends MovieClip 
	{
		...
		private var COMMENTED_BY:String = "commentedBy";
		private var COMMENT_TEXT:String = "commentText";
		
		private const APP_TYPE:String = "application/json";
		private var model:AppModel = AppModel.getInstance();
		
		public function SetCommentsServiceLocator(obj:ICommand, service:String) 
		{
			callBackObj = obj;
			services = service;
			connectToService();
		...
		public function connectToService():void
		{
			...
			ureq = new URLRequest();
			ureq.url = services + COMMENTED_BY + "=" + model.assocaiteID + "&" +PROBLEM_ID + "=" + model.problemIDForFeed + "&" + COMMENT_TEXT + "=" + model.commentText; 
			trace(ureq.url);
